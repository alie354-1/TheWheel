-- FINAL: Enhanced Feedback and Sharing System (2025-06-11)

-- 1. Ensure author_user_id is UUID in deck_comments
DO $$
BEGIN
  IF EXISTS (
    SELECT 1
...
-- 2. Recreate comment_visibility table with UUID id
...
-- 4. RLS policies for deck_comments
...
-- 5. RLS for comment_visibility: allow users to see only their own entries
