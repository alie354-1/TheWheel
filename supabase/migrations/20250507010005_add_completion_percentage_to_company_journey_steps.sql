...
-- Now fix the domain_steps_status view to reference the completion_percentage properly
DROP VIEW IF EXISTS domain_steps_status;

-- Recreate with proper join conditions and column references
...
-- Fix the domain_step_statistics view
