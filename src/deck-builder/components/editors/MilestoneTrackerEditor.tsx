...
import { MilestoneTrackerBlock as MilestoneTrackerBlockType, Milestone } from '../../types/blocks';

interface MilestoneTrackerEditorProps {
  block: MilestoneTrackerBlockType;
  onChange: (block: MilestoneTrackerBlockType) => void;
}

export const MilestoneTrackerEditor: React.FC<MilestoneTrackerEditorProps> = ({ block, onChange }) => {
  ...
  const addMilestone = () => {
    onChange({
      ...
      milestones: [
        ...milestones,
        { label: '', date: '', description: '', completed: false }
      ]
    });
  };
...
export default MilestoneTrackerEditor;
