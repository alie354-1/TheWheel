-- Migration: Update get_domain_steps function to support enhanced domain-step relationships and recommendations
...
COMMENT ON FUNCTION public.get_domain_steps IS 'Returns all domain steps for a specific company and domain, with rich metadata and optional recommendations.';
