...
import { StepTasksChecklist } from "./StepTasksChecklist.tsx";
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-lg max-w-lg w-full p-6 relative" tabIndex={0} style={{ maxHeight: "90vh", overflowY: "auto" }}>
        ...
        {peerInsights && Array.isArray(peerInsights) && peerInsights.length > 0 && (
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc pl-5 text-sm text-blue-700">
            {Array.isArray(step.resource_links) && step.resource_links.length > 0 ? (
