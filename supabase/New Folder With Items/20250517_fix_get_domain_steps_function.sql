-- Migration: Fix get_domain_steps function to use correct column in company_journey_steps
...
COMMENT ON FUNCTION public.get_domain_steps IS 'Returns all domain steps for a specific company and domain, with rich metadata and optional recommendations. (Fixed join to company_journey_steps)';
