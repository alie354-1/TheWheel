 ...
 * Design System
 * 
 * This file contains the design tokens and theme configuration for the UI rewrite.
 * It defines colors, typography, spacing, shadows, and other design elements
...
// Export all design tokens as a theme object
export const theme = {
  colors,
  typography,
  spacing,
