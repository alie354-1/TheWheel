...
export default function ProfileSetupDemo({ onComplete, onBack }: ProfileSetupDemoProps) {
    ...
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <div className="mt-8 flex justify-between pt-6 border-t border-gray-200">
        ...
        <div className="flex space-x-3">
          ...
          >
            {currentStep === SETUP_STEPS[SETUP_STEPS.length - 1].id ? 'Complete' : 'Next'}
            {currentStep !== SETUP_STEPS[SETUP_STEPS.length - 1].id && <ArrowRight className="h-4 w-4 ml-2" />}
          </button>
        </div>
      </div>
    </div>
